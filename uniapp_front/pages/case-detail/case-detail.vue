<template>
	<view class="page">
		<TopAppBar variant="detail" title="ZCD41DAC的家" />
		<scroll-view scroll-y class="scroll" :style="{ height: scrollHeight + 'px' }">
			...
			<view class="card team">
				...
				<view class="team-avatars">
					<view v-for="n in 4" :key="n" class="team-avatar" />
				</view>
			</view>
					...
					<view class="feed-header">
						...
						<view>
							<view class="feed-name-row">
								<text class="feed-name">张师傅</text>
								<text class="feed-badge">水电</text>
							</view>
							<text class="feed-time">2小时前</text>
						</view>
					</view>
					<view class="feed-body">
						<text class="feed-title">· 强弱电布线完成</text>
						<view class="feed-image" />
					</view>
				</view>
			</view>
...
<style scoped>
	.page { min-height: 100vh; background: #fdf9f2; }
	.scroll { padding: 0 32rpx; }
	.trust-bar {
		display: flex;
		align-items: center;
	...
	.tag-row { display: flex; gap: 16rpx; margin-top: 16rpx; }
	.tag {
		padding: 4rpx 16rpx;
		background: #f1ede6;
		border-radius: 8rpx;
	...
	.cost-header { display: flex; justify-content: space-between; align-items: flex-start; }
	...
	.cost-desc { font-size: 22rpx; color: #434654; margin-top: 4rpx; }
	...
	.team-grid { display: grid; grid-template-columns: 1fr 1fr; gap: 24rpx; margin-top: 16rpx; }
	.team-member { display: flex; gap: 16rpx; align-items: center; }
	.team-icon {
		width: 56rpx; height: 56rpx; background: #f1ede6;
	...
	.team-avatar { width: 80rpx; height: 80rpx; border-radius: 50%; background: #d4cfc7; }
	...
	.feed-item { background: #fff; border-radius: 24rpx; padding: 24rpx; }
	.feed-header { display: flex; gap: 16rpx; }
	.feed-avatar { width: 64rpx; height: 64rpx; border-radius: 50%; background: #c8d4e0; }
	...
	.feed-image { height: 360rpx; background: #d0d8c8; border-radius: 16rpx; margin-top: 16rpx; }
	.bottom-bar {
		position: fixed; left: 0; right: 0; bottom: 0;
		display: grid; grid-template-columns: 1fr 1.2fr; gap: 32rpx;
	...
	.btn-secondary {
		...
		background: transparent; color: #1c1c18; border-radius: 0; font-size: 24rpx; border: none;
	}
	.btn-primary {
		height: 88rpx; line-height: 88rpx;
		background: #003da6; color: #fff; border-radius: 24rpx; font-size: 24rpx; border: none;
